...
def make_pdf_P_cond(labels, data):
    ...
    return pdf
#print(train_data.Gender=='Female')
print()
#print(train_data.Height)
```
...
#print(train_data)
#print(train_data.Height)
#print(train_data.BMI)
#nb_prob(test_data.Height, test_data.BMI)
nb_prob = make_pdf_P_cond_NB(train_data['Gender']=='Female', train_data.Height, train_data.BMI)
```

```{python slideshow={'slide_type': 'skip'}}
print((test_data.Gender=='Female'))
#print(len(nb_prob(test_data.Height, test_data.BMI)))
#print(nb_prob(test_data.Height, test_data.BMI))
